...
protocol DriveRepositoryProtocol {
    ...
    func refresh(client: any TeslaMateAPI, serverID: UUID, carID: Int, page: Int, filter: DateRangeFilter) async throws -> [DriveRecord]
    func detail(client: any TeslaMateAPI, serverID: UUID, carID: Int, driveID: Int) async throws -> DriveDetailDTO
}
...
protocol ChargeRepositoryProtocol {
    ...
    func refresh(client: any TeslaMateAPI, serverID: UUID, carID: Int, page: Int, filter: DateRangeFilter) async throws -> [ChargeRecord]
    func detail(client: any TeslaMateAPI, serverID: UUID, carID: Int, chargeID: Int) async throws -> ChargeDetailDTO
}
